...
#obp.setBaseUrl("https://api.sandbox.ing.com")
#obp.setBaseUrl("https://api.sandbox.ing.com/v2/accounts")
obp.setBaseUrl("https://accenture.openbankproject.com/")
obp.setApiVersion("v4.0.0")

# Login and set authorized token
obp.login('Robert.Uk.33', 'X!9664614a', "5yi2eyaxltkqibfs3ghpojt1u3ay3jngnbzaoeiq")
